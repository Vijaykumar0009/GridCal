...
GridCal is licensed under the [MIT License v3.0](https://github.com/Vijaykumar0009/GridCal/blob/main/LICENSE) (MIT)
...
of the modue must be MIT too. An example of a non-derivative work is if you use 
